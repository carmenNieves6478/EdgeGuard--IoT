...
print("[*] Ampliando Metodología a 12+ páginas y refinando Anexos como Procedimiento Técnico...")

# ------------------------------------------------------------------------------
# 1. METODOLOGÍA (Extenso: 12+ Páginas con Ecuaciones, TikZ, Tablas y Algoritmos)
# ------------------------------------------------------------------------------
tex_metodologia_completa = r"""\section{METODOLOGÍA EXPERIMENTAL Y DISEÑO DEL SISTEMA}
...
with open(os.path.join(SEC_DIR, "metodologia.tex"), "w", encoding="utf-8") as f:
    f.write(tex_metodologia_completa)

# ------------------------------------------------------------------------------
# 2. ANEXOS (Procedimiento Técnico de Replicabilidad en lugar de Código Bruto)
# ------------------------------------------------------------------------------
tex_anexos_procedimiento = r"""\section{ANEXOS Y GUÍA DEL PROCEDIMIENTO TÉCNICO DE REPLICABILIDAD}
...
with open(os.path.join(SEC_DIR, "anexos.tex"), "w", encoding="utf-8") as f:
    f.write(tex_anexos_procedimiento)

print("[✔] Metodología ampliada a 12+ páginas y Anexos refinados como Procedimiento Técnico.")
